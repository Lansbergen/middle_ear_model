...
change.ec_l = 1.3 * sample_factor(i);     % length ear-canal cm
change.ec_d = 0.7 * sample_factor(i);     % diameter ear-canal cm
change.mec_v = 8 * sample_factor(i);     % middle-ear cavity volume cc/ml/cm^3
...
change.mec_R = 80 * sample_factor(i);     % middle-ear cavity resistance
...
change.addC = 105 * sample_factor(i);     % add acoustic ohm to reactance
...
title('95% Confidence Bounds healthy 12 M.O. ear');
hold on
